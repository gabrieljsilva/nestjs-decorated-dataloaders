...
let DataloaderMetadataService = class DataloaderMetadataService {
    ...
    getMetadata(parent, child) {
        var _a;
        return (_a = this.relations.getEdges(parent)) === null || _a === void 0 ? void 0 : _a.get(child);
    }
    getDataloaderHandler(key) {
...
//# sourceMappingURL=dataloader-metadata.service.js.map