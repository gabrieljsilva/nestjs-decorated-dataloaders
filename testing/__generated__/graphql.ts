...
export type UsersWithPhotosForClearQueryVariables = Exact<{ [key: string]: never; }>;


export type UsersWithPhotosForClearQuery = { __typename?: 'Query', users: Array<{ __typename?: 'UserEntity', id: number, name: string, createdAt: any, photos: Array<{ __typename?: 'PhotoEntity', id: number, url: string, userId: number }> }> };
...
export const UsersWithPhotosForClearDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UsersWithPhotosForClear"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"users"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"photos"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}}]}}]}}]}}]} as unknown as DocumentNode<UsersWithPhotosForClearQuery, UsersWithPhotosForClearQueryVariables>;
